<template>
  <div class="share_pop m-width">
    <el-popover :width="190" :visible="visible" placement="right-start" popper-class="popper_style" :show-arrow="false">
      <template #reference>
        <div class="share_style flex-row" title="Share" @click="visible = !visible">
          <!-- <el-icon>
      ...
      <template #default>
        <ul class="demo-rich-conent">
          ...
          <li @click="shareTwitter">
            <div class="m-width flex-row">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" class="iv">
