const writer = (to) => {
  ...
  document.head.childNodes.forEach(item => {
    switch (item.tagName) {
      ...
      case "TITLE":
        ...
        document.title = `${name}${t}Lagrange`;
        break;
    }
  });
  ...
  {
    name: "description",
    content: "Lagrange is an all-in-one decentralized computing platform to store and deploy code securely, empowering developers to build web3 apps through a full suite of Web3 tooling."
  },
  {
    property: "og:title",
    content: "Lagrange"
  ...
  {
    property: "og:url",
    content: "https://lagrange.computer"
  },
  {
    property: "og:image",
    content: "https://lagrange.computer/logo.png"
  },
  {
